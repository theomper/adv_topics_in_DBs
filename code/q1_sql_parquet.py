...
spark = SparkSession.builder.appName("query1-sql-parquet").getOrCreate()
...
res.repartition(1).write.format("com.databricks.spark.csv").option("header", "true").save("hdfs://master:9000/outputs/q1_parquet")
